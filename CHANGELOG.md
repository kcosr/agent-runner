...
- Fixed the web attachment preview flow so full-row clicks in the detail drawer open previewable attachments and browser/mobile back returns to the selected run's Attachments view instead of closing the drawer.
